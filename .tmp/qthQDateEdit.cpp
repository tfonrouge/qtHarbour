/*
 * $Id: qthQDateEdit.wip 126 2011-04-12 15:44:57Z tfonrouge $
 *
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_QDATEEDIT )
{ "QDATEEDIT", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( QDATEEDIT )}, NULL },
...
HB_INIT_SYMBOLS_END( hb_vm_SymbolInit_QDATEEDIT )
...
{
    /*
     * _public_functions_ : QDateEdit ( QWidget * parent = 0 )
     */
    if( ( hb_pcount() <= 1 ) && qth_Is( 1, "QWidget", QTH_DEFAULT ) )
    {
        QWidget* parent = hb_param( 1, HB_IT_OBJECT ) ? qth_parPtr<QWidget>( 1 ) : ( QWidget* ) 0;
        qth_itemPushReturn( QtH::QDateEdit, new QDateEdit( parent ) );
        return;
    }
    /*
     * _public_functions_ : QDateEdit ( const QDate & date, QWidget * parent = 0 )
     */
    if( ( hb_pcount() <= 2 ) && qth_IsObject( 1, "QDate" ) && qth_Is( 2, "QWidget", QTH_DEFAULT ) )
    {
        ...
        qth_itemPushReturn( QtH::QDateEdit, new QDateEdit( date, parent ) );
        return;
    }
    qth_errRT_PARAM();
}
